@echo off
 ...
 echo This DOES NOT update your mission file, that must be done by you.
 echo  This will download the files from Torndeco's Bitbucket.
 echo URL: https://bitbucket.org/torndeco/extdb3/downloads/
 pause
 set mypath=%cd%
 mkdir @ExileServer\sql_custom\
 mkdir @ExileServer\logs\
 title Downloading https://bitbucket.org/torndeco/extdb3/downloads/extDB3-1031.7z
 powershell -command "& { iwr https://bitbucket.org/torndeco/extdb3/downloads/extDB3-1031.7z -OutFile tmp.7z }"
 7z x tmp.7z -o*
 ...
 echo Thanks again to Torndeco for making Extdb3 Happen
 echo URL: https://bitbucket.org/torndeco/extdb3/
 pause
